...
const { defaults, formDefaults, formSettings } = require('../config/settings.cfg')
...
exports.getSettings = () => readFile(envPath).then((val) => getSettingsVars(Object.keys(formSettings), parse(val.toString())))
