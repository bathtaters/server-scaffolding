...
commonMiddleware.all && server.use(commonMiddleware.all)
commonMiddleware.api && server.use(urls.api.prefix, commonMiddleware.api)
commonMiddleware.gui && server.use(notRoute(urls.api.prefix), commonMiddleware.gui)
